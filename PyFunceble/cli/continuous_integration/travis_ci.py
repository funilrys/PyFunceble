...
class TravisCI(ContinuousIntegrationBase):
    """
    Provides the interface which detects and work under the Travis CI
    infrastructure.
    """

    def guess_and_set_authorized(self) -> "TravisCI":
        """
    ...
    def guess_and_set_token(self) -> "TravisCI":
        """
        Tries to guess and set the token.
        """

        environment_var = EnvironmentVariableHelper("GH_TOKEN")
