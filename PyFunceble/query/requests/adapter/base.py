...
class RequestAdapterBase(requests.adapters.HTTPAdapter):
    ...
    def fake_response() -> requests.models.Response:
        ...
        response.url = f"http://{PyFunceble.storage.NOT_RESOLVED_STD_HOSTNAME}"
        response.status_code = HTTPStatusCode.STD_UNKNOWN_STATUS_CODE
        response._content = "".encode("utf-8")  # pylint: disable=protected-access
        response.history = [response]
        response.headers = {
            "X-Message": "This is a fake header generated by "
            f"{PyFunceble.storage.PROJECT_NAME}.",
            "X-Reason": "Could not resolve.",
        }
