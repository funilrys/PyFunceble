...
latex_documents = [
    (master_doc, 'PyFunceble.tex', 'PyFunceble Documentation',
     'Nissar Chababy (@funilrys)', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyfunceble', 'PyFunceble Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyFunceble', 'PyFunceble Documentation',
     author, 'PyFunceble', 'One line description of project.',
     'Miscellaneous'),
]
