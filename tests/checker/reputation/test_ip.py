...
Tests of our IP reputation checker.
...
class TestIPReputationChecker(reputation_test_base.ReputationCheckerTestBase):
    """
    Tests of the IP reputation checker.
    """
    ...
    def test_query_status_positive_ipv4(self) -> None:
        ...
        the given IPv4 is known to be malicious.
        """

        self.mock_query_tool.return_value = ["127.176.134.253"]

        self.checker.subject = "127.176.134.253"
    ...
    def test_query_status_positive_ipv6(self) -> None:
        """
        Tests the method which let us query the status for the case that
        the given IPv6 is known to be malicious.
        """

        self.mock_query_tool.return_value = self.fake_query_a_record()

        self.checker.subject = "2606:2800:220:1:248:1893:25c8:1946"
        self.checker.query_status()
    ...
    def test_query_status_negative_ipv4(self) -> None:
        """
        Tests the method which let us query the status for the case that
        the given IPv4 is not known to be malicious.
        """
    ...
    def test_query_status_negative_ipv6(self) -> None:
        """
        Tests the method which let us query the status for the case that
        the given IPv6 is not known to be malicious.
        """
